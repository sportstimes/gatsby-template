  ...
  return (
    <Layout>
      ...
      <div id="about">
        ...
        <p>If you want to publish your own calendar of events for others to reference with ease, <Link to="https://github.com/kickofftimes/gatsby-template">clone the repo</Link>, customise to your hearts content and host on your own website or domain.</p>
